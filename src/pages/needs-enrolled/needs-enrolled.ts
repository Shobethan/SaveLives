// imports necessary packages for the needs enrolled page
...
@IonicPage()
@Component({
  selector: 'page-needs-enrolled',
  templateUrl: 'needs-enrolled.html',
})

export class NeedsEnrolledPage {
      ...
      var check = ref.once("value")
        .then(function (snapshot) {
          ...
          snapshot.forEach(function (childSnapshot) {
            var isEnrolled = childSnapshot.child(`enrolleddonors/${userId}`).exists();
            if (isEnrolled) {
